...
const ORDER = [
  ...
  ['contrast',     'text against its background, both languages'],
  ...
  ['longword',     'a word too long for the screen, at 320, 360 and 390'],
  ['devices',      'ten real screen sizes, both orientations'],
