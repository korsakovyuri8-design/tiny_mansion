/* ==========================================================
   ...
   баннер согласия не нужен, а текст на странице приватности,
...
(function () {
  ...
  s.defer = true;
  s.src = SRC;
  /* Plausible читает data-domain, Umami читает data-website-id. Ставим оба:
  ...
  /* Глубина прокрутки считается только там, где она что-то значит: длинная
